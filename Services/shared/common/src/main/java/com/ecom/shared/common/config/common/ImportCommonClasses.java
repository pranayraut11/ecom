...
@Import(value = {DtoValidator.class, SecurityConfig.class, Translator.class, KeycloakConfiguration.class, EcomExceptionHandler.class, WebClientConfig.class, I18Config.class, AppController.class})
